...
import { LoadingQuote, Quote } from './'; //importamos con ARCHIVO BARRIL index.js (Directorio 03-examples)
//no fue necesario porner el segundo directorio porque LoadingQuote, Quote estan en el mismo de MultipleCustomHooks
